...
{
    uint8 *s = (uint8 *)state;
    __m128i R = _mm_set_epi32(S_I_01[s[15]] ^ S_I_02[s[2]] ^ S_I_03[s[5]] ^ S_I_04[s[8]],
                              S_I_01[s[11]] ^ S_I_02[s[14]] ^ S_I_03[s[1]] ^ S_I_04[s[4]],
                              S_I_01[s[7]] ^ S_I_02[s[10]] ^ S_I_03[s[13]] ^ S_I_04[s[0]],
                              S_I_01[s[3]] ^ S_I_02[s[6]] ^ S_I_03[s[9]] ^ S_I_04[s[12]]);
    *state = _mm_xor_si128(R, KEY[round]);
    return;
}
...
{
    uint8 *s = (uint8 *)state;
    __m128i R = _mm_set_epi8(S_I[s[15]], S_I[s[2]], S_I[s[5]], S_I[s[8]],
                             S_I[s[11]], S_I[s[14]], S_I[s[1]], S_I[s[4]],
                             S_I[s[7]], S_I[s[10]], S_I[s[13]], S_I[s[0]],
                             S_I[s[3]], S_I[s[6]], S_I[s[9]], S_I[s[12]]);
    *state = _mm_xor_si128(R, KEY[10]);
    return;
}
